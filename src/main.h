...
public:
    ...
    {
        // Bbtcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Bbtcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Bbtcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Bbtcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Bbtcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Bbtcoin: block index flags
    enum  
    {
