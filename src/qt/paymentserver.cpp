...
const QString BITCOIN_IPC_PREFIX("Bbtcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Bbtcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Bbtcoin: click-to-pay handler");
    else
...
{
    // clicking on Bbtcoin: URLs creates FileOpen events on the Mac:
